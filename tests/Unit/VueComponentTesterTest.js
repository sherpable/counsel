...
module.exports = class VueComponentTesterTest extends TestCase
{
    ...
    {
        let vueComponentTester = new (counsel().resolve('VueComponentTester'))(this, `<hello-world foo="bar" bar="baz"></hello-world>`);
        this.assertEquals({
            foo: 'bar',
            bar: 'baz',
    ...
    {
        let vueComponentTester = new (counsel().resolve('VueComponentTester'))(
            this,
            `<hello-world
                foo="bar"
                bar="baz"
